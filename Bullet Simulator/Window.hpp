...
class Window
{
	Window(short screen_width, short screen_height, short map_width, short map_height);
	~Window();
...
public:
	...
	static Window* GetInstance(short screen_width, short screen_height, short map_width, short map_height);
